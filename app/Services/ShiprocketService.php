...
class ShiprocketService
{
    ...
    public function createOrder(Order $order): array
    {
        ...
        $payload = [
            ...
            'billing_email'         => $user?->email ?? (Setting::get('contact_email', 'support@threadax.co.in')),
            'billing_phone'         => $address?->phone ?? ($user?->phone ?? Setting::get('whatsapp_number', '9876543210')),
